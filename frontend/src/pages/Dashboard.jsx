...
function HeroFocusCard({ score, isDistracted, currentTask, focusMinutes, message, isEmpty = false }) {
        ...
        <div className="flex items-center justify-center lg:justify-end">
          ...
          >
            ...
            <div className="relative text-center">
              ...
              <div className="mt-2 text-[11px] uppercase tracking-[0.34em] text-slate-500">Focus score</div>
              <div
...
export default function Dashboard() {
  ...
  const weeklyPattern = useMemo(() => {
    ...
    return [
      { day: "Mon", hours: 1.6 }, { day: "Tue", hours: 2.0 },
      { day: "Wed", hours: 1.8 }, { day: "Thu", hours: 2.3 },
      { day: "Fri", hours: 1.4 }, { day: "Sat", hours: 1.2 },
      { day: "Sun", hours: 2.0 },
    ];
  }, [analytics]);
  ...
  return (
    <div className="flex min-h-screen bg-[#040816] text-white">
      ...
      <main className="min-h-screen flex-1 overflow-y-auto">
        ...
        >
          <HeroFocusCard
            score={isDashboardEmpty ? 0 : liveFocusScore}
            isDistracted={isDistracted}
            currentTask={isDashboardEmpty ? "No task yet" : currentTask}
            focusMinutes={isDashboardEmpty ? 0 : focusMinutes}
            message={isDashboardEmpty ? "Add a task or start a study session to activate your dashboard." : heroMessage}
          ...
          <motion.div variants={staggerInner()} initial="hidden" animate="show" className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <MetricCard label="Study time" value={isDashboardEmpty ? "0h 0m" : `${Math.floor(studyMinutes / 60)}h ${studyMinutes % 60}m`} subtext={isDashboardEmpty ? "Waiting for activity" : "Focused work today"} icon={AlarmClock} tint="#8b5cf6" isEmpty={isDashboardEmpty} />
          ...
          <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
            <UsageInsights usageData={isDashboardEmpty ? [
              { name: "Study apps", value: 1, display: "0h 0m", color: "#34d399" },
              { name: "Distracting apps", value: 1, display: "0m", color: "#fb7185" },
              { name: "Short breaks", value: 1, display: "0m", color: "#8b5cf6" },
            ] : usageData} mostUsedApp={isDashboardEmpty ? "No app yet" : mostUsedApp} isEmpty={isDashboardEmpty} />
